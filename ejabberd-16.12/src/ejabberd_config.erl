...
%     io:format("~n===============================~n~p~n~n", [{?MODULE, ?LINE, State0}]),
% ===============================
% {ejabberd_config,69,
%     {state,
%         [{local_config,
...
%               {s2s_shaper,[{fast,[all]}]}]},
%          {local_config,{shaper,global},[{fast,50000},{normal,1000}]},
%          {local_config,
%              {modules,global},
%              [{mod_adhoc,[]},
...
%               {mod_register,[{access_from,register},{access,register}]},
%               {mod_roster,[]},
%               {mod_shared_roster,[]},
%               {mod_stats,[]},
%               {mod_time,[]},
...
%          {local_config,{loglevel,global},4},
...
%                {shaper,c2s_shaper},
%                {access,c2s}],
%               [{port,5269},{module,ejabberd_s2s_in}],
%               [{port,5280},
...
%          {local_config,{auth_method,global},[mnesia]},
...
%               {c2s,[{deny,[{acl,blocked}]},{allow,[all]}]},
%               {configure,[{allow,[{acl,admin}]}]},
%               {local,[{allow,[{acl,local}]}]},
%               {muc_create,[{allow,[{acl,local}]}]},
%               {pubsub_createnode,[{allow,[{acl,local}]}]},
%               {register,[{allow,[all]}]},
%               {registration_timeout,[{infinity,[all]}]},
%               {trusted_network,[{allow,[all]}]}]},
...
%     io:format("~n===============================~n~p~n~n", [{?MODULE, ?LINE, State4}]),
% ===============================
% {ejabberd_config,172,
%     {state,
%         [{local_config,
%              {shared_key,global},
%              <<"b23d3baddea03c9660f7ed0a171d3ee7a0bcfadd">>},
%          {local_config,{node_start,global},1497510747},
%          {local_config,
%              {shaper_rules,global},
%              [{c2s_shaper,[{none,[{acl,admin}]},{normal,[all]}]},
%               {max_user_offline_messages,[{5000,[{acl,admin}]},{100,[all]}]},
